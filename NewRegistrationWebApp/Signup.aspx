            ...
            <div class="container">
                <div class="row align-items-center py-5">
                    ...
                    <div class="col-lg-5 px-lg-4">
                        ...
                        <div class="form-group mb-4">
                            <asp:RadioButtonList ID="RadioButtonListGender" style="height:70px;" required="true" CssClass="form-control border-0 shadow form-control-lg text-base"  runat="server">
                        ...
                        <div class="form-group mb-4">
                            <asp:Label ID="AOF" Text="Area of Intrest :  " runat="server" />
                        ...
                        <asp:Button ID="ButtonReg" Text="Sign up" CssClass="btn btn-primary" Height="50px" Width="200px" runat="server" OnClick="Unnamed8_Click" />
                         <asp:Button ID="btnLogin" runat="server" CssClass="btn btn-primary" Height="50px" Text="Login" OnClick="BtnLogin_Click" Width="200px" UseSubmitBehavior="False" />
                    </div>


                    
                    <div id="popupDiv" class="col-lg-3 px-lg-4" style="height:74px; width:90px; border:2px solid; background-color: antiquewhite; color:green;  top: -1100px; left: 471px;" runat="server" visible="false">
                        <asp:Label Text="Registration Successfull" runat="server" />
                        <asp:Button ID="doneReg" Text="Ok"  CssClass="btn btn-primary" runat="server" OnClick="done_ClickReg" UseSubmitBehavior="False" style="margin-left:10px; margin-top:5px;" />
                    </div>
