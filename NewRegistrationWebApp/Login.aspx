        ...
        <div class=" page-holder d-flex align-items-center">
            <div class="container">
                <div class="row align-items-center py-5">
                    ...
                    <div class="col-lg-5 px-lg-4">
                        ...
                        <div class="form-group mb-4">
                            <div class="custom-control custom-checkbox">
                                ...
                                <asp:LinkButton ID="backtoRegister" Style="margin-left: 40px;" Text="Create New Account" runat="server" OnClick="BacktoRegister" />
                    ...
                    <div id="popupDiv" class="col-lg-3 px-lg-4" style="height:74px; width:90px; border:2px solid; background-color: antiquewhite; color:green; top: -202px; left: 471px;" runat="server" visible="false">
                        <asp:Label Text="Login Successfull" runat="server" />
                        <asp:Button ID="done" Text="Ok"  CssClass="btn btn-primary" runat="server" OnClick="done_Click" UseSubmitBehavior="False" style="margin-left:10px; margin-top:5px;" />
                    </div>
                    ...
                    <div class="container-fluid">
                        <div class="row">
                            ...
                            <div class="col-md-6 text-center text-md-right text-gray-400">
                                <p class="mb-0">DEsign by <a href="#">Prachi</a></p>
